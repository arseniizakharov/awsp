...
mkdir -p /tmp/awsp-v1.0.6-aarch64-apple-darwin
install -m 0755 target/aarch64-apple-darwin/release/awsp /tmp/awsp-v1.0.6-aarch64-apple-darwin/awsp
COPYFILE_DISABLE=1 tar -czf /tmp/awsp-v1.0.6-aarch64-apple-darwin.tar.gz -C /tmp awsp-v1.0.6-aarch64-apple-darwin
shasum -a 256 /tmp/awsp-v1.0.6-aarch64-apple-darwin.tar.gz
gh release upload v1.0.6 /tmp/awsp-v1.0.6-aarch64-apple-darwin.tar.gz --repo arseniizakharov/awsp
```
...
The `v1.0.6` Apple Silicon binary checksum is:

```text
1049359dabfd0693f2eda1fbfd4926650c90c456bffd34879fd37de19c0b9944
```
